...
- **現況**: **v3.3.0 を準備中**(`package.json` / `APP_VERSION` は上げてあります)。
  ⚠ **まだ公開していません** ── 本番へ配る引き金(`v*` tag / `release.yml` の手動起動)は
  user の示唆を待ちます(user 指示 2026-08-19)。**公開済みの最新は v3.2.0(2026-08-29)**で、
  tag は `v3.0.0` 2026-08-03 / `v3.1.0` 2026-08-19 / `v3.2.0` 2026-08-29。以降の是正・機能追加は
