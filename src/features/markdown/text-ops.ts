...
export const FORMAT_OPS: readonly {
  ...
  { op: 'link', label: 'リンク', hint: 'リンクの形を入れて、URL の所を選んだ状態にします' },
  {
    ...
    hint: '2 列の表のテンプレートを差し込みます(選んでいれば、選んだ行を表にします)',
  },
  /**
   ...
   */
  {
    ...
    hint: '図のテンプレートを差し込みます(選んでいれば、選んだ範囲を ```mermaid で囲みます)',
    onBar: false,
  },
  {
    op: 'codeblock',
    ...
    hint: 'コードブロックのテンプレートを差し込みます(選んでいれば、選んだ範囲を ``` で囲みます)',
  },
  /**
   ...
   */
  {
    ...
    label: '数式',
    // 🔴 #950: 選んでいれば、選んだ範囲を $$ で囲みます(選んだ字は消えません)
    hint: '中央寄せの数式のテンプレートを差し込みます(選んでいれば、選んだ範囲を $$ で囲みます)',
  },
  /**
