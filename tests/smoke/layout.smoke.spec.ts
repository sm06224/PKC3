 ...
 */
/*
 * ⚠ **1248 と 1101 を足した**(C16 / #1045、2026-09-25)── 窓を 1100px から広げた
 *   **1101〜1248px の全域**で「作る」帯が 3 段に折れていたのに、どの幅も
 *   その帯域に入っていなかったので、下の「2 段まで」は一度も鳴らなかった
...
test('🔴 まとめ操作の帯は 2 段に収まり、ボタンは 1 つも消えていない (#475)', async ({
  ...
  const WANT = ['ファイルを取り込む', 'バックアップ', '操作を探す', '集計', 'システム', 'フラグ', 'ヘルプ'];
 ...
 * 画面のどこにも無い。マニュアル「行の右クリックから整理する」の「中央は常にいま開いているノート」の当の破れ。
 */
