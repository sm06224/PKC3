...
test('🔴 「システム」の目次: お知らせが読め、押すと移動し、目次へ戻るで戻り、hash は不変', async ({
   ...
   *   #1042 でも同じ形で落ちていた ── 前の題名(#1053「ボタンの名前を…」)を
   *   pin したまま、`2026-09-25-list-nav-and-escape` を**その前**に足したので、
   *   実物では新しい方が出ているのに、この spec は 1 段古い題名を待っていた)。
   ...
   * ⚠ 2026-09-25(#1054 段②)に `2026-09-25-icon-tiles` を先頭へ足したので、
   *   ここも 1 段新しい題名へ直した。
   * ⚠ 2026-09-25(#1038 台帳③ C1)に `2026-09-25-row-menu-edit` を先頭へ足したので、
   *   ここも 1 段新しい題名へ直した。
   * ⚠ 2026-09-25(#1038 台帳③ 段 D / C4)に `2026-09-25-editing-status-word` を
   *   さらに先頭へ足したので、もう 1 段新しい題名へ直した。
   * ⚠ 2026-09-26(#1038 台帳③ 段 G、C13)に `2026-09-26-list-multi-select` を先頭へ
   *   足したので、ここも 1 段新しい題名へ直した。
   * ⚠ 2026-09-26(#1038 台帳③ 段 J、C18)に `2026-09-26-settings-choice-buttons` を先頭へ
   *   足したので、ここも 1 段新しい題名へ直した。
   * ⚠ 2026-09-26(#1044 段2、章だけ編集)に `2026-09-26-section-edit` を先頭へ
   *   足したので、ここも 1 段新しい題名へ直した。
   */
  ).toContain('見出しの右クリックから、その章だけをその場で編集できるようになりました');
