...
describe('絞り込み(P7b review M-1/M-2/M-3)', () => {
  ...
  it('🔴 予定も同じ規則で絞られる', () => {
    ...
    d.dispatch({
      ...
      scan: {
        cards: [
          { lid: 'e1', line: 0, text: 'やること 1', done: false, date: '2026-08-25', time: null, until: null, repeat: null, substitutes: null },
          { lid: 'e2', line: 0, text: 'やること 2', done: false, date: '2026-08-25', time: null, until: null, repeat: null, substitutes: null },
        ],
        totalNotes: 2,
        scannedNotes: 2,
        truncated: false,
