...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string, shipped?: 'main'][] = [
     ...
     */
    /**
     * ⚠ **#811 の 2 番目(保存先をヘルプに出す)で足した**(2026-09-09)。枠(30 件)は余っている。
     * 🔑 まだ配っていない ── `git log --oneline origin/main -S"2026-09-09-storage-where"` が 0 件。
     */
    /**
     * ⚠ **#681 段③(本文の csv を SQL から引く)で足した**(2026-09-09)。枠は余っている。
     * 🔑 まだ配っていない ── `git log --oneline origin/main -S"2026-09-09-sql-csv"` が 0 件。
     */
    /**
    ...
    ['2026-09-09-sql-csv', '9aed1844'],
    ['2026-09-09-storage-where', '46fbc5c7'],
    /**
