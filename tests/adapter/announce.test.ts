...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
     ...
     */
    ['2026-09-25-list-nav-and-escape', 'PLACEHOLDER'],
    /**
     ...
     */
    /**
     * ⚠ **#971 段②(書き込む前に空きを見る)で足した**(2026-09-16)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**(`2026-09-14-sql-stay`)を
     *   落とした ── 原本は `CHANGELOG.md` に在る(配布済み: ca54f469)。
     */
    ['2026-09-16-write-quota', '9accf700'],
