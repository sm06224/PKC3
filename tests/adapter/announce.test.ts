...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
    ...
    /**
     * ⚠ **#530 案 A(付箋の形)で足した**(2026-09-14、user 裁定)。枠(30 件)が
     *   満杯だったので、**いちばん古い 1 件**(`2026-09-11-recent-sort`)を落とした
     *   ── 落とす相手は **origin/main に在るもの**から選んだ(e80ba89)。
     */
    ['2026-09-14-place-shape', 'a71e7d56'],
    /**
