...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
     ...
     */
    ['2026-09-14-repeat-move', 'ad086aa4'],
    ['2026-09-13-icon-list-fold', 'ed3a4d05'],
    ['2026-09-13-search-field-name', 'e84c7520'],
    /**
     * ⚠ **#855 決1(予定の札を指で動かす)で足した**(2026-09-13)。枠(30 件)が
     *   満杯だったので、**いちばん古い 1 件**(`2026-09-09-saving-line`)を落とした
     *   ── 落とす相手は **origin/main に在るもの**から選んだ(9d118e3)。
     */
    ['2026-09-13-schedule-touch-drag', 'e35cc74d'],
    /**
     * ⚠ **#854 段②(手持ちのファイルを開く)で足した**(2026-09-13)。枠(30 件)が
     *   満杯だったので、**いちばん古い 1 件**(`2026-09-09-open-scan`)を落とした
     *   ── 落とす相手は **origin/main に在るもの**から選んだ(698446e)。
     */
    ['2026-09-13-sql-open-local-file', '1eda6ed0'],
    /**
     * ⚠ **#854 段①(添付の csv)で足した**(2026-09-13)。枠(30 件)が満杯だったので、
     *   **いちばん古い 1 件**(`2026-09-09-phone-links`)を落とした ── 落とす相手は
     *   **origin/main に在るもの**から選んだ(0d29fee)。
     */
    ['2026-09-13-sql-csv-attachment', '0ee9acd9'],
    /**
