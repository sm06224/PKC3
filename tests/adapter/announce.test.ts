...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
     ...
     */
    ['2026-09-14-sql-answer-to-file', 'cdf7c572'],
    /**
     ...
     */
    ['2026-09-14-sql-input-grow', 'abe12974'],
    /**
     * ⚠ **#918 段②a(打つ欄の ↑ ↓ と字下げ)で足した**(2026-09-14、user 要望)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**
     *   (`2026-09-12-scrollbar-thin`)を落とした ── 落とす相手は
     *   **origin/main に在るもの**から選んだ(f521e19)。
     */
    ['2026-09-14-sql-input-keys', '01dcd516'],
    /**
     * ⚠ **#918 段①(構造をノートへ)で足した**(2026-09-14、user 要望)。枠(30 件)が
     *   満杯だったので、**いちばん古い 1 件**(`2026-09-12-builtin-tile-icons`)を落とした
     *   ── 落とす相手は **origin/main に在るもの**から選んだ(793152d)。
     */
    ['2026-09-14-sql-schema-note', 'de7a94d6'],
    /**
     * ⚠ **#772 段① B(聞くときだけ音を整える)で足した**(2026-09-14)。枠(30 件)が
     *   満杯だったので、**いちばん古い 1 件**(`2026-09-12-app-tile-icons`)を落とした
     *   ── 落とす相手は **origin/main に在るもの**から選んだ(bebb24b)。
     */
    ['2026-09-14-voice-boost', 'a6b4f3fc'],
    /**
     * ⚠ **#683 段②a(録音の切り出し)で足した**(2026-09-14、user 裁定)。枠(30 件)が
     *   満杯だったので、**いちばん古い 1 件**(`2026-09-11-material-icons`)を落とした
     *   ── 落とす相手は **origin/main に在るもの**から選んだ(76a01ab)。
     */
    ['2026-09-14-audio-trim', 'fc2fb00f'],
    /**
