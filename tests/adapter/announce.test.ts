...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
    ...
    /**
     * ⚠ **#530(名前に日本語)で足した**(2026-09-15、user 裁定)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**(`2026-09-13-app-group-fold`)を
     *   落とした ── 落とす相手は **origin/main に在るもの**から選んだ。
     *   原本は `CHANGELOG.md` に在る。
     */
    ['2026-09-15-place-name-japanese', '4df59fdb'],
    /**
