...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
    ...
    /**
     * ⚠ **#950(選んだ字を囲む)で足した**(2026-09-16)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**
     *   (`2026-09-13-pinned-app-settings`)を落とした(配布済み: 5f10ef4)。
     */
    ['2026-09-16-wrap-selection', 'ff3d20a9'],
    /**
     * ⚠ **#951(帯の余りが灰色に塗られる)で足した**(2026-09-16)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**
     *   (`2026-09-13-app-open-target`)を落とした ── 落とす相手は
    ...
    /**
     * ⚠ **#953 / #551 C(拡大すると段の区切り線がにじむ)で足した**(2026-09-15)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**
     *   (`2026-09-13-link-favicon`)を落とした ──
     *   落とす相手は **origin/main に在るもの**から選んだ(2ac66ea)。
     *   原本は `CHANGELOG.md` に在る。
     */
    ['2026-09-15-read-columns-crisp-rule', '9bf6eb51'],
    /**
     * ⚠ **#948(このアプリについて)で足した**(2026-09-15)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**
     *   (`2026-09-13-app-group-icon-palette`)を落とした ──
     *   base commit(段 0 で確かめた 27072c1)の時点で main に在るので配布済み。
     *   原本は `CHANGELOG.md` に既に在る。
     */
    ['2026-09-15-about-oss', '71a64776'],
    /**
