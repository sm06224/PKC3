...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string, shipped?: 'main'][] = [
     ...
     * ⚠ **同じ日に main へ入った**(PR #822 → feee82a)ので印を付けた。
     */
    ['2026-09-09-scrap-paste', '48131bd1', 'main'],
    /** ⚠ **#818(zip の中を見る)で足した**(2026-09-09)。 */
     ...
     *   ── 中身を変えても既読の user には届かない。
     */
    ['2026-09-08-block-handoff', '6e5799b8', 'main'],
    /**
     * ⚠ **#684 段④(落とした所へ入れる)で足した**(2026-09-08)。枠(30 件)は
     *   15 件しか埋まっていないので、押し出す相手は無い。
     * ⚠ 2026-09-09 に **main へ入った**(PR #807 → 88d1a1f)ので、印を付けた。
     *   ⚠ この entry の 4 つ目の行は「線が出るのは、いま開いているノートの本文の上だけ」
     *   と言っているが、**㋑ でそこが変わった** ── 配ってあるので直さず、
     *   上の `2026-09-09-file-drop-pinned` が言い直す。
     */
