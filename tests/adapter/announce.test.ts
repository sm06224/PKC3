...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [string, string][] = [
     ...
     */
    ['2026-09-08-manual-chapters', 'f5a840d0'],
    ['2026-09-08-note-button-blocked', 'f1bc83bf'],
    ['2026-09-08-table-convert-quote', 'f4110378'],
    ...
    /**
     * 🔴 **2026-09-08 に「配った姿」へ戻した**(user 報告「マニュアル分割が dev 版に
     *   反映されてないが? ヘルプのお知らせにも載ってない」)。
     ...
     * 🔑 だから章の割り直しは**新しい 1 件**(`2026-09-08-manual-chapters`)へ移した。
     ...
     *   これから読む人に嘘を出さない側を採った。
     */
    ['2026-09-06-primary-action', 'dc996f5c'],
