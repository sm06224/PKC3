...
describe('お知らせの文面は固定(#220-7)', () => {
  ...
  const KNOWN: readonly [id: string, digest: string][] = [
     ...
     */
    ['2026-09-21-system-sections', '9e32cea9'],
    /**
    ...
    /**
     * ⚠ **#959(SQL の選び所が戻る)で足した**(2026-09-16)。
     *   枠(30 件)が満杯だったので、**いちばん古い 1 件**
     *   (`2026-09-13-tile-open-target-once`)を落とした(配布済み: 71c808d)。
     */
    ['2026-09-16-sql-source-stays', '3dd394a2'],
