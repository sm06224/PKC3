...
| `.claude/agents/pkc3-surveyor.md` | 実地調査員(**read-only**、file:line で根拠) |
| `.claude/skills/mutation-testing/` | 変異試験の手順 + **動くハーネスの雛形** |
| `.claude/skills/smoke-testing/` | 実ブラウザ検証(2 つのブラウザ / 観測点の置き方) |
| `.claude/commands/review.md` `mutate.md` | 上を明示的に呼ぶ導線 |
